...
import 'widgets/place_dash_card.dart';

class PlaceDashboardView extends GetView<PlaceDashboardController> {
  @override
            ...
            Obx(() => ListView(
                  ...
                  children: [
                    ...
                    ListView.builder(
                      shrinkWrap: true,
                      physics: BouncingScrollPhysics(),
                      itemCount: controller.myPlaceList.length,
                      itemBuilder: (context, index) => PlaceDashCard(
                        placeModel: controller.myPlaceList[index],
                      ),
                    ),
                  ],
                )),
