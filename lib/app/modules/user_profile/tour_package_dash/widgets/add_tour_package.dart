...
class AddTourPackage extends GetView<TourPackageDashController> {
  const AddTourPackage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Create Tour Package'),
                ...
                children: [
                  Expanded(
                    child: ElevatedButton(
                      ...
                      child: Text('Create Tour Package',
          ...
          children: [
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                labelText: 'Tour Package Details',
                border: OutlineInputBorder(),
              ),
            ),
            kVerticalSpaceM,
